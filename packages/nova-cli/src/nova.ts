...
import { NovaAgent, type NovaEvent } from "@archymedes/nova-core/nova-cli/agent";
...
import { askModelForSuggestions, mergeModelSuggestions, type Suggestion as EngineSuggestion } from "@archymedes/nova-core/nova-cli/suggestions";
import type { ModelUsage } from "@archymedes/nova-core/providers/model";
import { NovaSessionDaemon, type DaemonApprovalRequest, type DaemonNotification, type NovaDaemonClient } from "@archymedes/nova-core/nova-cli/daemon";
import type { NovaMode, PermissionDecision } from "@archymedes/nova-core/nova-cli/permissions";
import { assessTaskSafety, type SafetyAssessment } from "@archymedes/nova-core/nova-cli/safety";
import { listSessions, loadSession, type SessionRecord } from "@archymedes/nova-core/nova-cli/session";
import { catalogPrices, describeProviders, PRICE_ENVIRONMENT_HINT, PROVIDER_IDS, resolveProvider, type ProviderId } from "@archymedes/nova-core/providers/agent-matrix";
import { convertTo, fromUnits, formatMoney, isCurrency, priceUsage, type Currency, type FxRate, type Money, type TokenPrices } from "@archymedes/nova-core/money";
import { createExaClient } from "@archymedes/nova-core/providers/exa";
import { downloadProject, DockerWorkspace, E2BWorkspace, LocalWorkspace, uploadProject, type NovaWorkspace } from "@archymedes/nova-core/nova-cli/backends";
import type { AgentRuntimeResult } from "@archymedes/nova-core/agent-runtime";
import { CostLedger } from "@archymedes/nova-core/nova-cli/cost";
...
import { PRICE_CATALOG } from "@archymedes/nova-core/providers/price-catalog";
...
import { CACHE_CHURN_HINT } from "@archymedes/nova-core/nova-cli/cost";
...
import { fetchProviderModels, fetchableProviders, isCacheFresh, loadLiveModels, mergeModelLists, readModelCache } from "@archymedes/nova-core/providers/model-fetch";
...
import { WANDER_LAB_FILES } from "@archymedes/nova-core/wander";
import {
  appendJobLog,
  cancelJob,
  enqueueJob,
...
import { BillingError, billingFromEnvironment, newIdempotencyKey, waitForPayment, type Balance } from "@archymedes/nova-core/nova-cli/billing";
import { IMPLICIT_SKILL_PROVIDER_ID } from "@archymedes/nova-core";
...
async function main(): Promise<number> {
  ...
  const createWorkspace = async (request: WorkspaceRequest): Promise<{ workspace: NovaWorkspace } | { error: string }> => {
    ...
    if (request.backend === "e2b") {
      ...
      const { findWorkspacePreset } = await import("@archymedes/nova-core/sandbox-templates");
      const { createE2BProvider } = await import("@archymedes/nova-core/providers/factory");
    ...
    if (request.backend === "docker") {
      ...
      const { createDockerProvider } = await import("@archymedes/nova-core/providers/factory");
