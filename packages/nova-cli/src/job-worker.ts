...
import type { ApprovalPrompt } from "@archymedes/nova-core/nova-cli/permissions";
import { loadSession } from "@archymedes/nova-core/nova-cli/session";
import { LocalWorkspace, type NovaWorkspace } from "@archymedes/nova-core/nova-cli/backends";
import type { AgentTurnProvider } from "@archymedes/nova-core/agent-runtime";
import type { ModelPriceCatalog } from "@archymedes/nova-core/model-cost";
import type { ExaSearchClient } from "@archymedes/nova-core/providers/exa";
import { isWanderObjective, WANDER_LAB_FILES } from "@archymedes/nova-core/wander";
import {
  appendJobLog,
  claimJob,
  consumeJobApproval,
