import type { Suggestion as EngineSuggestion } from "@archymedes/core/cli/suggestions";
import {
  defaultSignals,
  shouldOfferStarters,
  starterSuggestions,
...
} from "@archymedes/core/cli/suggestions";
 ...
 *
 * Archymedes has grown past forty slash commands and as many flags, and a list that long is not a menu —
...
export const COMMAND_GROUP: Readonly<Record<string, NavGroupId>> = {
  ...
  "/todos": "review", "/task": "review", "/diff": "review", "/undo": "work", "/retry": "work", "/continue": "work", "/cost": "review", "/expand": "review",
 ...
 * because nothing has yet taught them that the mode decides what Archymedes may do without asking.
 */
