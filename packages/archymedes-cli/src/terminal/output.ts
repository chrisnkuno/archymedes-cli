 ...
 *
 * Archymedes's renderer grew up calling `process.stdout.write` directly — a hundred and sixty times, from
 ...
 * already module state (`markdown`, `statusBar`, `glyphs` — see `archymedes.ts`), because there is one
