 ...
 *
 * Archymedes's default layout writes each line to stdout and forgets it: the terminal keeps the history,
 ...
 * the price is that Archymedes must now do the three things the terminal was doing for free. This module
 ...
 * ever will, because it is the terminal's own. Rather than reimplement copy, Archymedes hands the buffer
