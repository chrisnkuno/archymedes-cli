...
/**
 * The drawing surface every chart is drawn on — Archymedes's answer to ntcharts' canvas.
 *
 ...
 * was the only plot and became the thing standing between Archymedes and a scatter or a streaming series.
