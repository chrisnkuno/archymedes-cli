 ...
 *
 * This is the one place in Archymedes that owns a screen instead of appending to a transcript, and it is
 ...
 * `archymedes --version` and every other invocation that never draws a screen — the dependency is
