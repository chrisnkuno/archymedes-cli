...
/**
 * The starfield Archymedes opens with.
 *
 ...
 *
 * `NO_COLOR` and a non-TTY stdout both mean plain text. Piping Archymedes's output into a file and
...
/** Solid block lettering, which reads as solid at any terminal font size. */
const WORDMARK = [
  "  ██   █████   ████  █    █ █    █ █    █ ██████ █████  ██████  █████",
  "█    █ █    █ █    █ █    █  █  █  ██  ██ █      █    █ █      █     ",
  "██████ █████  █      ██████   ██   █ ██ █ █████  █    █ █████   ████ ",
...
const WORDMARK_WIDTH = 69;

/**
 * The same letters in characters no encoding can mangle.
 *
 * Not a smaller banner — a *different* one, because the block wordmark above is unreadable
