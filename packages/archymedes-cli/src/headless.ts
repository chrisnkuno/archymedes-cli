...
import { runtimeEventForJournal } from "@archymedes/core/cli/protocol";

/**
 * Archymedes speaking to a program instead of a person.
 *
 ...
 * indistinguishable from Archymedes never having run at all.
 */
...
export class HeadlessEmitter {
   ...
   */
  agentEvent(event: ArchymedesEvent): void {
