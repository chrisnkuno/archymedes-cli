...
describe("the transcript Archymedes keeps for itself", () => {
  ...
  it("survives a terminal too small to have a body at all", () => {
    // A frame that computes a negative height crashes or paints nothing, and both look like Archymedes
...
describe("searching the transcript Archymedes now owns", () => {
  const withContent = () =>
