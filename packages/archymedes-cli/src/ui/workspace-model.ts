...
import type { TabView } from "../session/tabs";
import { StreamSeries, waveLine } from "../render/charts";
import { visibleWidth } from "../text/text-width";
import { clip } from "../render/sections";
import { scrollIndicator, scrollPercent } from "../render/tui";
 ...
 *   surface is added, the thing being drawn does not move. Archymedes's transcript renderer already
 *   works this way (`sections.ts` returns strings, `archymedes.ts` decides where they go), and this is
 ...
 * checkable by comparing strings, which is how the rest of Archymedes's rendering is already verified.
 */
