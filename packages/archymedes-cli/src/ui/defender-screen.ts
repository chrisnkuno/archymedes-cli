...
import { note, panel, rule, type SectionStyle } from "../render/sections";
import { padToWidth, stepProgress, scrollIndicator } from "../render/tui";
import { applyViewport, newViewport, scrollFraction, visibleLines } from "../terminal/viewport";
