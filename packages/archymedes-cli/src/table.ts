 ...
 * navigation rules should teach every surface Archymedes has; `chooser.ts` makes that argument at length
...
export function advanceTable(
  ...
  // Tab, not Escape, hands the keyboard over. Escape leaving outright is what every other Archymedes
