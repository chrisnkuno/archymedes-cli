 ...
 * Every entry names a *native readline* replacement — not a Archymedes feature, not something this file
...
export const DEFAULT_BINDINGS: readonly { command: string; chords: readonly string[]; description: string }[] = [
  ...
  { command: "/memory", chords: ["alt+n"], description: "Facts Archymedes carries between sessions" },
...
/**
 * Parses `ARCHYMEDES_KEYS`, e.g. `"/diff=alt+d, /wander=off"`.
 *
