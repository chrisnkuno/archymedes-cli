...
/**
 * A PNG decoder, because the alternative was a dependency Archymedes cannot justify.
 *
 * Every image library in this ecosystem — sharp, jimp, canvas — is either a native addon that has
 * to be compiled per platform or several megabytes of pure JavaScript, and Archymedes ships as a single
