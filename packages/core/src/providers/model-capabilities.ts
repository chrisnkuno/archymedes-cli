 ...
 *
 * Archymedes used to answer both questions with one constant each: a 200,000-token context limit and a
 ...
 * limits Archymedes used before this file existed. Guessing a large window for an unrecognised id turns
...
/**
 * What an unrecognised model is assumed to do: exactly what Archymedes assumed for everything before.
 *
...
/**
 * The output ceiling Archymedes asks for by default, whatever the model could theoretically produce.
 *
