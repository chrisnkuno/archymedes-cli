 ...
 *
 * Shared rather than written twice because the two callers — the hosted iterative worker and Archymedes
...
export const DEFAULT_IGNORED_DIRECTORIES = [".git", "node_modules", ".next", "dist", "build", "target", "__pycache__", ".venv", "venv", ".pytest_cache", ".mypy_cache", ".ruff_cache", ".turbo", "vendor", ".archymedes"] as const;
