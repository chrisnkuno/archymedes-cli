...
describe("what this package refuses to let rot", () => {
  ...
  it("has no test file whose subject has been deleted or renamed", () => {
    ...
    const orphans = tests
      ...
      .filter((expected) => !["providers/truncation.ts", "providers/streaming.ts", "cli/remember.ts", "cli/adversarial-policy.ts", "cli/workspace-conformance.ts", "cli/migration.ts", "cli/nested-instructions.ts", "cli/auto-mode.ts", "conformance.ts"].includes(expected));
