...
export type EnvironmentReport = {
  backend: ArchymedesWorkspace["kind"];
...
/** Programs worth knowing about in any project: the runtimes and the search/VCS tools Archymedes reaches for. */
 ...
 */
export async function probeEnvironment(workspace: ArchymedesWorkspace): Promise<EnvironmentReport> {
