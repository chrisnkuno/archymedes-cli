...
describe("spending beyond the model", () => {
  ...
  /**
   * The catalog rate is a published list price applied to a page count Archymedes counted; `reportedUsd`
...
describe("whether the prompt cache is actually working", () => {
  ...
  it("flags a prefix that keeps being rewritten and never read back", () => {
    // Writes exceeding reads, turn after turn, is the signature of an invalidated prefix: Archymedes pays
