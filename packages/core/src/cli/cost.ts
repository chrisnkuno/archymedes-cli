...
export type Expense = {
   ...
   * the catalog applies a published list price to a quantity Archymedes counted, while this is the number
 ...
 */
export function predictAgentUsage(input: { initialInputTokens: number; objective: string; mode: ArchymedesMode }): AgentCostPrediction {
...
export class CostLedger {
   ...
   * It is *writes exceeding reads once a conversation is under way*: Archymedes keeps paying the 1.25x
