...
| WS-2.10 | Extract remaining top-level helpers (help text, providers listing, FX rates, approval prompt, job-worker launch) → `app/` | todo | `archymedes.ts` | `bun run recheck --pty` | |
